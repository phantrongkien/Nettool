...
if %WINDOWSVER% GEQ 10 echo/                                             "  (       ,.     .      )        .    "  (   .             │ 
if %WINDOWSVER% GEQ 10 echo/                                              ("     )  )'     ,'        )  . (     '                    │ Versions :  2.1
if %WINDOWSVER% GEQ 10 echo/                                           ; )  ' (( (" )    ;(,     ((  (  ;)  "  )"   "  )"            ├───────────────────
if %WINDOWSVER% GEQ 10 echo/                                        ; ) "., ,._'_.,)_(..,( . )_  _' )_') (. _..( '..    ;(,          │  Running on :
if %WINDOWSVER% GEQ 10 echo/                                        ███╗   ██╗███████╗████████╗████████╗ ██████╗  ██████╗ ██╗        │   %username%'s PC
if %WINDOWSVER% GEQ 10 echo/                                        ████╗  ██║██╔════╝╚══██╔══╝╚══██╔══╝██╔═══██╗██╔═══██╗██║        │ 
if %WINDOWSVER% GEQ 10 echo/                                        ██╔██╗ ██║█████╗     ██║      ██║   ██║   ██║██║   ██║██║        ├──────────────────── 
if %WINDOWSVER% GEQ 10 echo/                                        ██║╚██╗██║██╔══╝     ██║      ██║   ██║   ██║██║   ██║██║        │Made by : Amsosc@re
if %WINDOWSVER% GEQ 10 echo/                                        ██║ ╚████║███████╗   ██║      ██║   ╚██████╔╝╚██████╔╝███████╗   │
if %WINDOWSVER% GEQ 10 echo/                                        ╚═╝  ╚═══╝╚══════╝   ╚═╝      ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝   │
